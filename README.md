...
Production-ready short-poll messaging reference built on Laravel 11 / PHP 8.2. Clients poll for encrypted messages with exponential backoff; the server responds immediately (no long polling, SSE, or WebSockets).
